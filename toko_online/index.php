...
<div class="mb-4 d-flex flex-wrap">
    <a href="index.php" class="btn btn-outline-primary me-2 mb-2 <?= (!isset($_GET['kategori']) && !isset($_GET['keyword'])) ? 'active' : '' ?>">Semua</a>
    ...
    ?>
    <a href="index.php?kategori=<?= $c['id'] ?>" class="btn btn-outline-primary me-2 mb-2 <?= $active ?>">
        <?= $c['name'] ?>
    </a>
    <?php endwhile; ?>
</div>
...
<div class="row">
    ...
    if (mysqli_num_rows($query) == 0) {
        echo "<div class='col-12 text-center py-5'>
                ...
                <a href='index.php' class='btn btn-secondary mt-3'>Lihat Semua Produk</a>
              </div>";
    }
