...
<div class="row">
    ...
    <div class="col-md-7">
        ...
        <p class="lead fw-bold mb-3">Stok Tersedia: 
            <span class="badge bg-<?= $produk['stock'] > 10 ? 'success' : ($produk['stock'] > 0 ? 'warning' : 'danger') ?> fs-6">
        ...
        <?php if ($produk['stock'] > 0): ?>
            ...
            <?php elseif (isset($_SESSION['user_id']) && $_SESSION['role'] == 'admin'): ?>
                <div class="alert alert-info">Anda login sebagai Admin. Tidak bisa membeli produk.</div>
            <?php else: ?>
                <div class="alert alert-warning">Silakan <a href="login.php" class="alert-link">login</a> sebagai user untuk membeli produk.</div>
            <?php endif; ?>
        <?php else: ?>
